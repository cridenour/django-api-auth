...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'api_apitoken', (
            ...
            ('token', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40, blank=True)),
    ...
    models = {
        u'api.apitoken': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'token'", 'unique': 'True', 'to': u"orm['auth.User']"})
        },
        u'auth.group': {
